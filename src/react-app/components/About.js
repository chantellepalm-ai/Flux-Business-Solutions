...
export default function About() {
    ...
    return (<section id="about" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-black border-2 border-neon-pink/50 rounded-2xl p-8 md:p-12 text-center shadow-neon-multi">
            ...
            <Link to="/contact" className="inline-block bg-gradient-to-r from-neon-pink to-neon-purple text-white px-10 py-5 rounded-full text-xl font-semibold shadow-neon-multi border-2 border-neon-pink/50 hover:border-neon-pink transition-all duration-300 transform hover:scale-105 group">
