...
export default function Footer() {
    ...
    return (<footer className="bg-black border-t-2 border-neon-pink/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <img src="https://019a3531-1a36-703a-9471-7514fb810b7c.mochausercontent.com/Modern-creative-agency-service-list-instagram-post-(portrait).jpg" alt="FLUX Logo" className="h-16 w-auto mb-4 transition-all duration-300 hover:scale-105 hover:drop-shadow-neon-pink"/>
          ...
          <div>
            ...
            { name: 'Contact', path: '/contact' }
                  ...
                  <button onClick={() => navigate(link.path)} className="text-gray-400 hover:text-neon-cyan transition-colors duration-300 text-sm hover:drop-shadow-neon-cyan">
                    {link.name}
                  </button>
                </li>))}
            </ul>
          ...
          <div>
            ...
            'Paid Ads & Lead Generation'
                  ...
                  <button onClick={() => navigate('/services')} className="text-gray-400 hover:text-neon-lime transition-colors duration-300 text-sm cursor-pointer hover:drop-shadow-neon-lime">
                    {service}
                  </button>
                </li>))}
            </ul>
