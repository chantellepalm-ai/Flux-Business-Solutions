            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black border-2 border-neon-pink/30 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-neon-pink focus:shadow-neon-pink transition-all duration-300"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-black border-2 border-neon-cyan/30 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-neon-cyan focus:shadow-neon-cyan transition-all duration-300"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-black border-2 border-neon-purple/30 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-neon-purple focus:shadow-neon-purple transition-all duration-300"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-black border-2 border-neon-lime/30 rounded-lg text-white focus:outline-none focus:border-neon-lime focus:shadow-neon-lime transition-all duration-300"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 bg-black border-2 border-neon-pink/30 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-neon-pink focus:shadow-neon-pink transition-all duration-300 resize-none"
              ...
              {submitStatus === 'success' && (
                <div className="mt-4 p-4 bg-neon-lime/10 border-2 border-neon-lime/50 rounded-lg text-neon-lime text-center shadow-neon-lime">
                  {submitMessage}
                </div>
              )}
              
              {submitStatus === 'error' && (
                <div className="mt-4 p-4 bg-red-500/10 border-2 border-red-500/50 rounded-lg text-red-400 text-center">
                  {submitMessage}
                </div>
              )}
            </form>
