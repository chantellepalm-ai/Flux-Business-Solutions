        ...
        {[...Array(30)].map((_, i) => (
          <div
            ...
            className={`absolute rounded-full animate-float ${
              i % 4 === 0 ? 'bg-neon-pink shadow-neon-pink' :
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className={`flex flex-col sm:flex-row gap-4 justify-center mb-16 transition-all duration-1000 delay-700 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <button
            ...
            className="bg-gradient-to-r from-neon-pink to-neon-purple text-white px-8 py-4 rounded-full text-lg font-semibold shadow-neon-multi transition-all duration-300 transform hover:scale-105 hover:shadow-neon-pink border border-neon-pink/50 hover:border-neon-pink group"
          >
            🔥 Let's Get Started
          ...
          <button
            ...
            className="border-2 border-neon-cyan text-neon-cyan px-8 py-4 rounded-full text-lg font-semibold hover:bg-neon-cyan hover:text-black transition-all duration-300 transform hover:scale-105 shadow-neon-cyan group"
          >
            ⚡ View Our Services
            <span className="ml-2 inline-block transition-transform duration-300 group-hover:translate-x-1">→</span>
          </button>
