...
export default function BlogPage() {
  ...
  const fetchBlogPosts = async (category: string = 'All') => {
    try {
      setLoading(true);
      setError(null);
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <button
              onClick={syncRSSFeed}
              disabled={syncing}
              className="mt-6 inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {error && !loading && (
            <div className="text-center py-16">
              ...
              <button
                onClick={() => fetchBlogPosts(selectedCategory)}
                className="px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300"
              >
                Try Again
              </button>
            </div>
          ...
          {!loading && !error && blogPosts.length === 0 && (
            <div className="text-center py-16">
              ...
              <button
                onClick={syncRSSFeed}
                disabled={syncing}
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300 disabled:opacity-50"
              >
                <RefreshCw className={`w-5 h-5 mr-2 ${syncing ? 'animate-spin' : ''}`} />
          ...
          <div className="text-center mt-16">
            <div className="bg-gradient-to-r from-pink-600/20 to-purple-600/20 border border-pink-500/30 rounded-2xl p-8">
              ...
              <a 
                ...
                className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-pink-500/25"
              >
