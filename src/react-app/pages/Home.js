...
export default function Home() {
    ...
    return (<div className="min-h-screen bg-black text-white">
      ...
      <section id="what-we-do" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-purple-950/20">
        ...
        ].map((service, index) => (<div key={index} className="group relative">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-purple-950/20 to-black">
        ...
        ].map((benefit, index) => (<div key={index} className="flex items-center space-x-4 group">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-purple-950/20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <button onClick={() => navigate('/contact')} className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-10 py-5 rounded-full text-xl font-semibold hover:shadow-xl hover:shadow-pink-500/25 transition-all duration-300 transform hover:scale-105 hover:glow-lg group">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-purple-950/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button onClick={() => navigate('/contact')} className="border-2 border-pink-500 text-pink-400 px-10 py-5 rounded-full text-xl font-semibold hover:bg-pink-500 hover:text-white transition-all duration-300 transform hover:scale-105 group">
